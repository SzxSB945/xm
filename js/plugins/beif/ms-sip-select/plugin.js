            ...
            avalon.component(pluginName, {
                ...
                defaults: {
                    ...
                    onInit: function () {
                        ...
                        _this._id = "ms-sip-select_" + $.getRandStr("an", 5);
    
                        if (_this.initData) {
                            _this.data.pushArray(_this.initData);
                            _this.dataLoaded = true;
    
                            $.merge(_this.$rawData, _this.initData);
                        }
                    },
                    ...
                    changeMode: function (mode) {
                        ...
                        if (mode == 1) {
                            if (!this.dataLoaded) {
                                ...
                                $.om.api.getSIPData(401, function (sipData) {
                                    _this.dataLoaded = true;
                                    _this.isLoading = false;
    
                                    _this.data.pushArray($.map(sipData, function (n) {
                                        return n.id401;
                                    }));
    
                                    $.merge(_this.$rawData, sipData);
                    ...
                    getValue: function (rawData) {
                        if (!rawData) {
                            ...
                            $.grep(this.$rawData, function (data) {
                                return valueArr.indexOf(data.id401) != -1;
                            });
                        }
                    }
                }
