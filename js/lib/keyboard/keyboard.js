...
(function() {
  ...
  this.VKI_kts = this.VKI_kt = "om8000";  // Default keyboard layout
  ...
  this.VKI_layout['om8000'] = {
    'name': "om8000", 'keys': [
      [["1", "!", "\u00a1", "\u00b9"], ["2", "@", "\u00b2"], ["3", "#", "\u00b3"], ["4", "$", "\u00a4", "\u00a3"], ["5", "%", "\u20ac"], ["6", "^", "\u00bc"], ["7", "&", "\u00bd"], ["8", "*", "\u00be"], ["9", "(", "\u2018"], ["0", ")", "\u2019"], ["Bksp", "Bksp"]],
      [["q", "Q", "\u00e4", "\u00c4"], ["w", "W", "\u00e5", "\u00c5"], ["e", "E", "\u00e9", "\u00c9"], ["r", "R", "\u00ae"], ["t", "T", "\u00fe", "\u00de"], ["y", "Y", "\u00fc", "\u00dc"], ["u", "U", "\u00fa", "\u00da"], ["i", "I", "\u00ed", "\u00cd"], ["o", "O", "\u00f3", "\u00d3"], ["p", "P", "\u00f6", "\u00d6"]],
      [["a", "A", "\u00e1", "\u00c1"], ["s", "S", "\u00df", "\u00a7"], ["d", "D", "\u00f0", "\u00d0"], ["f", "F"], ["g", "G"], ["h", "H"], ["j", "J"], ["k", "K"], ["l", "L", "\u00f8", "\u00d8"]],
      [["z", "Z", "\u00e6", "\u00c6"], ["x", "X"], ["c", "C", "\u00a9", "\u00a2"], ["v", "V"], ["b", "B"], ["n", "N", "\u00f1", "\u00d1"], ["m", "M", "\u00b5"]]
    ], 'lang': ["en"] };
            ...
            for (var x = 0; x < this.VKI_numpad.length; x++) {
              var ntr = document.createElement('tr');
                for (var y = 0; y < this.VKI_numpad[x].length; y++) {
                  ...
                  var div = document.createElement('div');
                    VKI_addListener(div, 'click', VKI_keyClick, false);
                    VKI_mouseEvents(div);
                    div.appendChild(document.createTextNode(this.VKI_numpad[x][y]));
                    ntd.appendChild(div);
                    ntr.appendChild(ntd);
  ...
  function VKI_keyClick() {
    ...
    if (this.firstChild.nodeName.toLowerCase() != "small") {
      if ((character = this.firstChild.innerHTML) == "\xa0") return false;
          ...
          var tr = document.createElement('tr');
            for (var y = 0, lkey; lkey = lyt[y++];) {
              ...
              td.appendChild(div);
                ...
                } else div.appendChild(document.createTextNode(lkey[0] || "\xa0"));
            ...
            if (type) {
              ...
              if (this.VKI_symbol[lkey[vchar]]) {
                ...
                for (var z = 0; z < text.length; z++) {
                  if (z) small.appendChild(document.createElement("br"));
                  small.appendChild(document.createTextNode(text[z]));
                } tds[y].appendChild(div);
              } else {
                div.appendChild(document.createTextNode(lkey[vchar] || "\xa0"));
                tds[y].appendChild(div);
              }
            }
            if (this.VKI_deadkeysOn.checked) {
